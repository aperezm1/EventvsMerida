 ...
 * @param fechaNacimiento nueva fecha de nacimiento del usuario. No puede ser futura
 *                        y debe cumplir la validación de edad establecida.
 * @param email nuevo correo electrónico del usuario. Debe tener un formato válido.
 * @param telefono nuevo número de teléfono del usuario. Debe tener 9 dígitos
 *                 y empezar por 6, 7 o 9.
 * @param password nueva contraseña del usuario. Debe tener al menos 8 caracteres,
