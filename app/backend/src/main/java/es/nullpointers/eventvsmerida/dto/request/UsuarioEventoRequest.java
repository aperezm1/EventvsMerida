 ...
 *
 * @param emailUsuario correo electrónico del usuario. No puede estar vacío y debe tener un formato válido.
 * @param tituloEvento título del evento que se quiere guardar o eliminar. No puede estar vacío.
