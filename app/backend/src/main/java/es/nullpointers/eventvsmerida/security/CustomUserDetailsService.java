 ...
 * proporcionar lógica de autenticación personalizada.
 *
 * @author Eva Retamar
 * @author David Muñoz
 * @author Adrián Pérez
...
public class CustomUserDetailsService implements UserDetailsService {
     ...
     * @return un objeto UserDetails que contiene la información del usuario para la
     *         autenticación.
     * @throws UsernameNotFoundException si el usuario con el email proporcionado no
